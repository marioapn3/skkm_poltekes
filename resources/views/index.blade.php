...
<body class="font-sans">
        ...
        <div
            ...
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1
                    ...
                    SIREKAM - Sistem Aplikasi Perekapan Dokumen dan Perhitungan Satuan Kredit Kegiatan Mahasiswa <br>
                </h1>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-lg px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            <!-- Row -->
                ...
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    ...
                    <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-teal-400 dark:text-teal-400" fill="currentColor"
    ...
    <section class="bg-white dark:bg-gray-900">
        <div
            class="items-center max-w-screen-lg px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            <div class="col-span-2 mb-8">
                <p class="text-lg font-medium text-teal-500 dark:text-teal-400">Trusted Worldwide</p>
                ...
                <div class="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
                    <div>
                        <a href="#"
                            class="inline-flex items-center text-base font-medium text-teal-500 hover:text-teal-600 dark:text-teal-400 dark:hover:text-teal-400">
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                <div>
                    <svg class="w-10 h-10 mb-2 text-teal-500 md:w-12 md:h-12 dark:text-teal-400" fill="currentColor"
                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
    ...
    <!-- Start block -->
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-lg px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
    ...
    <!-- Start block -->
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-lg px-4 py-8 mx-auto lg:py-24 lg:px-6">
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div
                    ...
                    <a href="#"
                        class="text-white bg-teal-500 hover:bg-teal-400 focus:ring-4 focus:ring-teal-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-teal-600">Get
                        started</a>
                </div>
                <!-- Pricing Card -->
                <div
                    ...
                    <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Check out this guide to learn how to <a
                                    href="#" class="text-teal-500 dark:text-teal-400 hover:underline">get
                    ...
                    <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">Check out the <a href="#"
                                    class="text-teal-500 dark:text-teal-400 hover:underline">Figma design
                    ...
                    <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <ul class="pl-5 text-gray-500 list-disc dark:text-gray-400">
                                <li><a href="#"
                                        class="text-teal-500 dark:text-teal-400 hover:underline">Landwind Pro</a>
                                </li>
                                <li><a href="#"
                                        class="text-teal-500 dark:text-teal-400 hover:underline">Tailwind UI</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-lg px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="max-w-screen-sm mx-auto text-center">
                ...
                <a href="#"
                    class="text-white bg-teal-400 hover:bg-teal-600 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-teal-500 dark:hover:bg-teal-400 focus:outline-none dark:focus:ring-teal-600">Free
                    trial for 30 days</a>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-white dark:bg-gray-800">
        <div class="max-w-screen-lg p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 Landwind™. All
                    Rights Reserved. Built with <a href="https://flowbite.com"
                        class="text-teal-500 hover:underline dark:text-teal-400">Flowbite</a> and <a
                        href="https://tailwindcss.com"
                        class="text-teal-500 hover:underline dark:text-teal-400">Tailwind CSS</a>.
                </span>
