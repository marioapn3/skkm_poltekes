...
<head>
    ...
    <title>Login - Poltekes Yogyakarta</title>
    ...
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        ...
        <div class="w-full max-w-xl p-6 space-y-8 bg-white rounded-lg shadow-lg sm:p-8 dark:bg-gray-800">
            <h2 class="text-2xl font-bold text-gray-900 ">
                Login ke <span class="text-teal-400 ">SIREKAM</span>
            </h2>
            <form class="mt-8 space-y-6" action="{{ route('auth.login') }}" method="post">
                ...
                <button type="submit"
                    class="w-full px-5 py-2 text-base font-medium text-center text-white bg-teal-400 rounded-lg hover:bg-teal-500 focus:ring-4 focus:ring-teal-300 sm:w-auto dark:bg-teal-300 dark:focus:ring-teal-500">Login</button>
