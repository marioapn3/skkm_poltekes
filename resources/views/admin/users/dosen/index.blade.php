                        ...
                        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-gray-400 md:ml-2 " aria-current="page">Dosen</span>
                                </div>
                            </li>

                        </ol>
                    </nav>
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl ">Users Dosen</h1>
                    <p class="text-gray-500 ">Manajemen Akun untuk Dosen</p>
                </div>
                <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                    <div class="flex items-center mb-4 sm:mb-0">
                        <form class="flex gap-2 sm:pr-3 " action="{{ route('admin.users.dosen.search') }}" method="GET">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr class="bg-white dark:bg-gray-800">
                                ...
                                <td class="px-6 py-4">{{ $user->lecture->nip }}</td>
                                {{-- <td class="px-6 py-4">{{ $user->lecture->prodi }}</td>
                                <td class="px-6 py-4">{{ $user->lecture->semester }}</td> --}}
                                <td class="px-6 py-4 ">
                                    <div class="flex gap-1">
                                        <a href="{{ route('admin.users.dosen.edit', $user->id) }}" id="validate_button"
                                            data-id="{{ $user->id }}" data-modal-target="popup-modal"
