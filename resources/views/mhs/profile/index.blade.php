...
@section('content')
    ...
    <div class="px-4 pt-6 rounded-lg">
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            ...
            <form action="{{ route('mhs.profile.update') }}" method="post">
                ...
                <div class="grid grid-cols-1 gap-4 lg:pr-56 xl:pr-72 md:grid-cols-2">
                    ...
                    <div>
                        <label for="lecture_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dosen
                            Pembimbing</label>
                        <select id="lecture" name="lecture_id"
                            class="lecture border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        ...
        <div
            ...
            <div class="w-full mb-5">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Update Password</h1>
