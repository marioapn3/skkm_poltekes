...
@section('title', 'Update Profile Dosen - Poltekes Yogyakarta')
@section('content')
    ...
    <div class="px-4 pt-6 rounded-lg">
        <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 ">
            ...
            <form action="{{ route('dsn.profile.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-4 lg:pr-56 xl:pr-72 md:grid-cols-2">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <input type="text" name="nip" id="nip"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  "
                            placeholder="Masukan NIP anda" value="{{ Auth::user()->lecture->nip }}">
                    </div>
                    {{-- <input type="file" name="signature_picture" id=""> --}}
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <img id='preview_img' class="object-cover w-auto h-40 mt-4 border border-gray-300 bg-gray-50 "
                            src="{{ asset(Auth::user()->lecture->signature_picture) }}" alt="Current profile photo" />
